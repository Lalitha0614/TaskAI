...
A production-ready, full-stack-ready task management web app built with **HTML, CSS, and JavaScript**, featuring **AI integration** via Google Generative Language API.
